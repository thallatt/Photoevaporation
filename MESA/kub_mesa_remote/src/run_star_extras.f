...
! ***********************************************************************
      ...
      subroutine extras_controls(id, ierr)
         ...
         s% other_adjust_mdot=> EL_mdot !EL_mdot !ELR_mdot !HD_mdot 
	 ...
	 muH=1.00794 !g/mol molar mass!!! why?
         ...
         if((s% star_age) < 8d6) then
            Feuv=3585.743422231086*(s% x_ctrl(1))**(-2) + 1048.7394601572157*(s% x_ctrl(1))**(-2)
         else
            Feuv= (s% x_ctrl(1))**(-2)*(1028.9795628130123*((s% star_age)/8d6)**(-1.2) + 3527.56375*((s% star_age)/8d6)**(-1.0))
